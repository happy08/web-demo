        ...
        >
            <div class="cy-toast-inner" :style="{'background-color':bgColor}">
                <span class="cy-toast-icon-wrapper">
                    <cy-loading v-if="type==='loading'" size="40" />
                    <cy-icon v-else-if="type==='success'" type="smile" color="#fff" size="40" />
                    <cy-icon v-else-if="type==='fail'" type="frown" color="#E64340" size="40" />
